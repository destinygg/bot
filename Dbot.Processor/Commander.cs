  ...
  public class Commander {
    ...
    public Commander(Message message, MessageProcessor messageProcessor) {
      ...
      { new List<string> { "refer", "sponsor" },
        () => "If you want to buy anything on Amazon (☞ﾟヮﾟ)☞ destiny.gg/amazon ☜(ﾟヮﾟ☜) Consider a Blue microphone\r\nGo from this ⑁ to this 💺 destiny.gg/chair ☜(⌒▽⌒)☞  destiny.gg/ting 25$ off Sprint network" },
      { new List<string> { "irc" },
