...
namespace Dbot.UnitTest {
  ...
  public class LongTests {
    ...
    public async Task ManualBanTest() {
      ...
      var s = new List<string> {
        "Banned UserX for 10m with the silent reason Manual bot ban.",
        "Banned UserX for 10m with the silent reason Manual bot ban.",
        "Banned UserX for 2m with the silent reason Manual bot ban.",
        "Banned UserX for 3m with the silent reason Manual bot ban.",
        "Banned UserX for 4m with the silent reason Manual bot ban.",
        "Banned UserX for 5m with the silent reason Manual bot ban.",
        "Banned UserX for 10m with the silent reason reason goes here",
        "Banned UserX for 10m with the silent reason reason goes here",
        "Banned UserX for 6m with the silent reason reason goes here",
        "Banned UserX for 7m with the silent reason reason goes here",
        "Banned UserX for 8m with the silent reason reason goes here",
        "Banned UserX for 9m with the silent reason reason goes here",
        "Banned UserX for 2h with the silent reason Manual bot ban.",
        "Banned UserX for 3h with the silent reason Manual bot ban.",
        "Banned UserX for 4h with the silent reason Manual bot ban.",
        "Banned UserX for 5h with the silent reason Manual bot ban.",
        "Banned UserX for 6h with the silent reason reason goes here",
        "Banned UserX for 7h with the silent reason reason goes here",
        "Banned UserX for 8h with the silent reason reason goes here",
        "Banned UserX for 9h with the silent reason reason goes here",
        "Banned UserX for 10h with the silent reason Manual bot ban.",
        "Permanently banned UserX with the silent reason Manual bot ban.",
        "Permanently banned UserX with the silent reason Manual bot ban.",
        "Permanently banned UserX with the silent reason Manual bot ban.",
        "Banned UserX for 1491308 days 2h with the silent reason Manual bot ban.",
      };
    ...
    public async Task ManualIpbanTest() {
      ...
      var s = new List<string> {
        "Permanently ipbanned UserX with the silent reason Manual bot ban.",
        "Permanently ipbanned UserX with the silent reason Manual bot ban.",
        "Ipbanned UserX for 2m with the silent reason Manual bot ban.",
        "Ipbanned UserX for 3m with the silent reason Manual bot ban.",
        "Ipbanned UserX for 4m with the silent reason Manual bot ban.",
        "Ipbanned UserX for 5m with the silent reason Manual bot ban.",
        "Permanently ipbanned UserX with the silent reason Manual bot ban.",
        "Permanently ipbanned UserX with the silent reason Manual bot ban.",
        "Ipbanned UserX for 6m with the silent reason reason goes here",
        "Ipbanned UserX for 7m with the silent reason reason goes here",
        "Ipbanned UserX for 8m with the silent reason reason goes here",
        "Ipbanned UserX for 9m with the silent reason reason goes here",
        "Ipbanned UserX for 2h with the silent reason Manual bot ban.",
        "Ipbanned UserX for 3h with the silent reason Manual bot ban.",
        "Ipbanned UserX for 4h with the silent reason Manual bot ban.",
        "Ipbanned UserX for 5h with the silent reason Manual bot ban.",
        "Ipbanned UserX for 6h with the silent reason reason goes here",
        "Ipbanned UserX for 7h with the silent reason reason goes here",
        "Ipbanned UserX for 8h with the silent reason reason goes here",
        "Ipbanned UserX for 9h with the silent reason reason goes here",
        "Ipbanned UserX for 10h with the silent reason Manual bot ban.",
        "Permanently ipbanned UserX with the silent reason Manual bot ban.",
        "Permanently ipbanned UserX with the silent reason Manual bot ban.",
        "Permanently ipbanned UserX with the silent reason Manual bot ban.",
      };
